...
//
//        float out9 = agent->nn->activationFunction(out1 + out2);
//        float out10 = agent->nn->activationFunction(out3 + out4);
//        float out11 = agent->nn->>activationFunction(out5 + out6);
//        float out12 = agent->nn->activationFunction(out7 + out8);
//
//        float out = agent->nn->activationFunction(out9*weights.at(8) + out10*weights.at(9) + out11*weights.at(10) + + out12*weights.at(11));
